...
|
*/
$config['base_url'] = 'http://localhost/electrical-system/';
...
|
*/
$config['log_threshold'] = 2; // set to 2 to enable debug messages (change to 4 for all)
...
$config['sess_cookie_name'] = 'as_session';
